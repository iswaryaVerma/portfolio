    ...
    <div class="form-horizontal">
      ...
      <div class="form-group" id="form-login">
        ...
        <div class="form-group" id="form-login">
          ...
          <div class="col-sm-8">
          <input id="id" value='<?php echo $_GET['id']; ?>' type='hidden'>
           <input type="text" class="form-control text-right" pattern="[0-9]{3}" onkeyup="validate_prog()" onkeydown="validate_prog()" name="prog" id="prog" required="" value="<?php echo $row2['progress'] ?>">
          </div>
        </div>
